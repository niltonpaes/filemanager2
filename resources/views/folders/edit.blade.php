...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Folder Properties</div>
                ...
                <div class="card-body">
                    <form method="POST" action="/folders/{{ $folder->id }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="foldername" type="text" class="form-control @error('foldername') is-invalid @enderror" name="foldername" value="{{ $folder->foldername }}" required>
